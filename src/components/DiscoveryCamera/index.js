...
render() {
    return (
     this.state.mounted ?   <Animated.View style={[this.styles.container]}>
        ...
        <View style={this.styles.textRow}>
          ...
          <TouchableOpacity onPress={() => {this.props.route.params.novideo ? this.openGallery('photo') : this.openGallery('all');}}>
          <Text style={this.styles.text} > Galerie</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={()=>{this.setState({photoSet:true})}}>
          <Text style={[this.styles.text,{color:this.state.photoSet ? '#0084ff' : 'white',fontWeight:this.state.photoSet ? 'bold' : 'normal'}]}  > Photo </Text>
            </TouchableOpacity>

          <TouchableOpacity onPress={()=>{this.setState({photoSet:false})}} >
            <Text style={[this.styles.text,{color:!this.state.photoSet ? '#0084ff' : 'white',fontWeight:!this.state.photoSet ? 'bold' : 'normal'}]}  > Video </Text>
          </TouchableOpacity>
             ...
             style={{
              ...
              marginLeft:10,
                  ...
                  <Icon
                    name="pause"
                    type='MaterialCommunityIcons'
                    style={{color:this.state.paused ? 'white' : '#f94c4c', fontSize:24 }}
                    onPress={this.pauseVideo}
                  />
           ...
           /* <TouchableOpacity
            ...
            <View
             ...
             <TouchableOpacity  onPress={this.takePicture} >
                 <View style={this.styles.thinView}>
                      <View style={this.styles.fullView}/>
                </View>
             </TouchableOpacity>
              :

                <TouchableOpacity onPress={()=>{ this.state.videoActivated ? this.deactivateVideo() : !this.props.route.params.novideo ? this.activateVideo() : null; }}>
                  <View style={this.styles.thinView}>
                     <View style={{alignItems:'center',justifyContent:'center'}}>
                      <View style={[this.styles.fullView,{justifyContent:'center',alignItems:'center'}]}>
                            {this.state.videoActivated ? <FontAwesome name="square" style={{color:'#f94c4c', fontSize:22 }}/> :
                            <FontAwesome name="circle"  style={{color:'#f94c4c', fontSize:20 }}/> }
                      </View>
                     </View>
                </View>
              </TouchableOpacity>
